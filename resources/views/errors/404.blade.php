...
<head>
    ...
    <title>Halaman Tidak Ditemukan — Novos</title>
...
<body class="bg-[#f5f5f5] flex flex-col items-center justify-center min-h-screen">
    <div class="text-center px-4">
        <div class="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <svg class="w-10 h-10 text-[#1a237e]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z"/>
            </svg>
        </div>
        <h1 class="text-6xl font-bold text-[#1a237e] mb-2">404</h1>
        <h2 class="text-xl font-semibold text-gray-900 mb-2">Halaman Tidak Ditemukan</h2>
        <p class="text-gray-500 mb-8 max-w-md mx-auto">Halaman yang Anda cari tidak tersedia atau sudah dipindahkan.</p>
