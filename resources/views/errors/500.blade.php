...
<head>
    ...
    <title>Terjadi Kesalahan — Novos</title>
...
<body class="bg-[#f5f5f5] flex flex-col items-center justify-center min-h-screen">
    <div class="text-center px-4">
        <div class="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <svg class="w-10 h-10 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
        ...
        <p class="text-gray-500 mb-8 max-w-md mx-auto">Server mengalami masalah. Tim kami sudah diberitahu. Silakan coba lagi nanti.</p>
