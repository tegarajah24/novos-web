...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Novos — Jersey custom premium, desain bebas, kualitas jahitan terbaik. Pesan jersey custom untuk tim, komunitas, dan acara kamu. Proses cepat 3-7 hari.')">
    ...
    <meta property="og:title" content="@yield('title', 'Novos — Custom Sports Jersey')">
    <meta property="og:description" content="@yield('meta_description', 'Novos — Jersey custom premium, desain bebas, kualitas jahitan terbaik. Pesan jersey custom untuk tim, komunitas, dan acara kamu.')">
    <meta property="og:url" content="@yield('canonical', url()->current())">
    <meta property="og:image" content="@yield('og_image', asset('images/hero-bg.png'))">
    <meta property="og:locale" content="id_ID">

    {{-- Twitter Card --}}
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="@yield('title', 'Novos — Custom Sports Jersey')">
    <meta name="twitter:description" content="@yield('meta_description', 'Novos — Jersey custom premium, desain bebas, kualitas jahitan terbaik.')">
    <meta name="twitter:image" content="@yield('og_image', asset('images/hero-bg.png'))">
