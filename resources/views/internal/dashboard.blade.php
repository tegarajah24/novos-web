...
@endphp
    ...
    <div class="grid grid-flow-col auto-cols-[calc(50%-0.375rem)] lg:grid-flow-row lg:grid-cols-4 gap-3 lg:gap-6 mb-8 overflow-x-auto lg:overflow-visible snap-x snap-mandatory scrollbar-hide">
        ...
        <a href="{{ route('staf.daftar-pesanan') }}" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6 flex flex-col hover:shadow-xl hover:border-[#1a237e]/30 hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
            <div class="flex justify-between items-start mb-3 md:mb-4">
                <div class="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-[#1a237e] flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 class="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight stats-counter" data-target="{{ $totalOrders }}">0</h3>
            <p class="text-gray-500 text-xs md:text-sm mt-1.5 md:mt-2 font-medium">Total Pesanan</p>
        </a>

        <!-- Card P2: Antrian Cetak -->
        <a href="{{ route('staf.daftar-pesanan') }}?status=siap_cetak" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6 flex flex-col hover:shadow-xl hover:border-red-300/50 hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
            <div class="flex justify-between items-start mb-3 md:mb-4">
                <div class="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-red-50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 class="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight stats-counter" data-target="{{ $printQueue }}">0</h3>
            <p class="text-gray-500 text-xs md:text-sm mt-1.5 md:mt-2 font-medium">Antrian Cetak</p>
        </a>

        <!-- Card P3: Sedang Diproduksi -->
        <a href="{{ route('staf.daftar-pesanan') }}?status=diproduksi" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6 flex flex-col hover:shadow-xl hover:border-purple-300/50 hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
            <div class="flex justify-between items-start mb-3 md:mb-4">
            ...
            <h3 class="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight stats-counter" data-target="{{ $sewingQueue }}">0</h3>
            <p class="text-gray-500 text-xs md:text-sm mt-1.5 md:mt-2 font-medium">Sedang Diproduksi</p>
        </a>
        ...
        <a href="{{ route('staf.daftar-pesanan') }}?status=menunggu_pembayaran" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6 flex flex-col hover:shadow-xl hover:border-orange-300/50 hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
            <div class="flex justify-between items-start mb-3 md:mb-4">
                <div class="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-orange-50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 class="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight stats-counter" data-target="{{ $pendingOrders }}">0</h3>
            <p class="text-gray-500 text-xs md:text-sm mt-1.5 md:mt-2 font-medium">Menunggu Pembayaran</p>
        </a>

        <!-- Card 3: Sedang Diproses -->
        <a href="{{ route('staf.daftar-pesanan') }}?status=tahap_produksi" class="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6 flex flex-col hover:shadow-xl hover:border-blue-300/50 hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
            <div class="flex justify-between items-start mb-3 md:mb-4">
                <div class="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-blue-50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <h3 class="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight stats-counter" data-target="{{ $inProcessOrders }}">0</h3>
            <p class="text-gray-500 text-xs md:text-sm mt-1.5 md:mt-2 font-medium">Sedang Diproses</p>
        </a>
