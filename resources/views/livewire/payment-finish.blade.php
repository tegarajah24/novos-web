<div class="max-w-lg mx-auto px-4 py-16 text-center">
    ...
    <div class="flex flex-col sm:flex-row gap-3 justify-center">
        @if($orderNumber)
        <a href="{{ route('tracking', ['q' => $orderNumber]) }}" class="px-8 py-3 bg-[#1a237e] text-white rounded-lg font-semibold hover:bg-[#283593] transition-colors text-center">Tracking Pesanan</a>
        @endif
        <a href="{{ route('beranda') }}" class="px-8 py-3 border-2 border-gray-300 text-gray-600 rounded-lg font-semibold hover:border-gray-400 hover:text-gray-800 transition-colors text-center">Kembali ke Beranda</a>
    </div>
</div>
