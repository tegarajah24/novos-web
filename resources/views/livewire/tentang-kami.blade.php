...
<section class="relative w-full bg-[#0f2040] overflow-hidden" style="min-height:400px">
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('images/bg-tentang.png') }}" alt="" class="w-full h-full object-cover opacity-[0.50]">
    </div>
    ...
    <div class="relative z-10 max-w-[1200px] mx-auto px-6 flex items-center" style="min-height:400px">
        <div class="max-w-2xl">
            <h1 class="text-4xl md:text-[56px] font-bold leading-tight text-white mb-5" data-aos="fade-up" data-aos-delay="100">Tentang <span class="text-[#00e5ff]">Novos</span></h1>
            <p class="text-base md:text-lg text-[#c8d6e0] leading-relaxed" data-aos="fade-up" data-aos-delay="200">Platform pemesanan jersey custom terpercaya untuk kebutuhan tim, komunitas, dan bisnis Anda. Kualitas premium, layanan mudah dan cepat.</p>
        </div>
    </div>
</section>
...
<div class="max-w-[1200px] mx-auto px-6 py-16">
    <div class="overflow-hidden">
        ...
        <div class="space-y-4 text-gray-600 leading-relaxed" data-aos="fade-up" data-aos-delay="200">
            <p><strong class="text-gray-900">Novos</strong> lahir dari kegelisahan para founder-nya yang merupakan pegiat olahraga di Purwokerto. Mereka merasa sulit mendapatkan jersey custom berkualitas tinggi dengan harga yang masuk akal tanpa harus memesan dari luar kota. Proses yang rumit, komunikasi yang tidak jelas, dan hasil yang tidak sesuai ekspektasi menjadi masalah yang terus berulang.</p>
            <p>Nama <strong class="text-gray-900">"Novos"</strong> berasal dari Bahasa Latin yang berarti <em>"baru"</em> atau <em>"pembaruan"</em>. Filosofi ini menjadi semangat kami untuk <strong class="text-gray-900">memperbarui cara orang memesan jersey custom</strong> — dari proses yang rumit menjadi mudah, dari harga yang mahal menjadi terjangkau, dari kualitas standar menjadi premium.</p>
            <p>Berdiri sejak tahun 2022, Novos fokus menyediakan jersey olahraga berkualitas tinggi untuk berbagai cabang olahraga seperti sepak bola, futsal, basket, voli, hingga running. Setiap jersey yang kami produksi menggunakan bahan <strong class="text-gray-900">Dryfit Premium</strong> yang nyaman dipakai, ringan, dan cepat kering.</p>
        </div>
    </div>
</div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden" data-aos="zoom-in">
            <div class="grid md:grid-cols-[1fr_auto_1fr] divide-y md:divide-y-0">
                <div class="p-8 md:p-10 flex flex-col" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-gray-600 leading-relaxed flex-1">Menjadi platform jersey custom nomor satu di Indonesia yang dikenal dengan kualitas terbaik, desain inovatif, dan pelayanan yang memuaskan.</p>
                </div>
                <div class="hidden md:flex items-stretch"><div class="w-px bg-gray-100 my-8"></div></div>
                <div class="p-8 md:p-10 flex flex-col" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul class="space-y-3 text-gray-600 flex-1">
                        <li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0 mt-2.5"></span><span>Menyediakan jersey custom berkualitas tinggi dengan bahan terbaik</span></li>
                        <li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0 mt-2.5"></span><span>Memberikan kemudahan pemesanan melalui sistem online yang transparan</span></li>
                        <li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0 mt-2.5"></span><span>Mendukung pelaku olahraga, komunitas, dan bisnis lokal</span></li>
                        <li class="flex items-start gap-3"><span class="w-1.5 h-1.5 rounded-full bg-gray-400 shrink-0 mt-2.5"></span><span>Terus berinovasi dalam desain dan teknologi produksi</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div x-ref="timScroll" @scroll="updateScroll()" class="flex gap-6 overflow-x-auto overflow-y-hidden pb-4 no-scrollbar scroll-smooth snap-x snap-mandatory">
            ...
            <div class="snap-start shrink-0 w-[calc(50%-12px)] md:w-[270px] group" data-aos="fade-up" data-aos-once="true" data-aos-delay="{{ ($loop->index % 5) * 100 }}">
                <div class="relative w-full overflow-hidden rounded-lg bg-gray-100 flex items-center justify-center" style="aspect-ratio:3/4">
                    @if($t['avatar'])
                    <img src="{{ asset('storage/' . $t['avatar']) }}" alt="{{ $t['fullname'] ?? $t['name'] }}" class="w-full h-full object-cover transition-transform duration-300 ease-out group-hover:scale-105">
                    @else
                    <div class="w-full h-full flex items-center justify-center bg-[#1a237e] text-white text-4xl font-bold">{{ strtoupper(substr($t['fullname'] ?? $t['name'], 0, 2)) }}</div>
                    @endif
                </div>
            ...
            @empty
            <div class="w-full text-center py-10 text-gray-500">Belum ada anggota tim.</div>
            @endforelse
        </div>
    </div>
</section>
